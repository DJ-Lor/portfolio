      ...
      <div className="w-72 h-fit group">
        <div className="relative overflow-hidden">
          <img
            ...
            alt=""
          />
          <div className="absolute h-full w-full bg-black bg-opacity-20 flex items-center justify-center -bottom-10 group-hover:bottom-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
